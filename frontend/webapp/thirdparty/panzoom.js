...
;((t, e) => {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(e)
      : ((t = "undefined" != typeof globalThis ? globalThis : t || self).Panzoom = e())
})(this, function () {
  var a,
    X = function () {
      return (X =
  ...
  var T = { down: "mousedown", move: "mousemove", up: "mouseup mouseleave" }
  function L(t, e, n, o) {
  ...
  function I(t, e) {
    ...
    else -1 < (n = G(t, e)) && t.splice(n, 1), t.push(e)
  }
  function R(t) {
  ...
  var q = {
    ...
    setTransform: function (t, e, n) {
      ...
      C(t, "transform", "scale(".concat(e.scale, ") translate(").concat(o, "px, ").concat(r, "px)")),
        a && i && ((e = window.getComputedStyle(t).getPropertyValue("transform")), t.setAttribute("transform", e))
    },
    startX: 0,
    startY: 0,
    startScale: 1,
  ...
  function t(u, f) {
    ...
    if (
      !((t) => {
        for (var e = t; e && e.parentNode; ) {
          if (e.parentNode === document) return 1
    ...
    t = u
    var t,
      l = Z.test(t.namespaceURI) && "svg" !== t.nodeName.toLowerCase(),
      n = u.parentNode
          ...
          "boolean" == typeof r.animate &&
            (r.animate
              ? ((t = u),
                (e = r),
                (n = Y("transform")),
                C(t, "transition", "".concat(n, " ").concat(e.duration, "ms ").concat(e.easing)))
              : C(u, "transition", "none")),
    ...
    function w(t, e, n, o) {
      var r,
        ...
        p = { x: m, y: h, opts: o }
      return (
        (!o.force && (o.disablePan || (o.panOnlyWhenZoomed && v === o.startScale))) ||
          ((t = parseFloat(t)),
          (e = parseFloat(e)),
          o.disableXAxis || (p.x = (o.relative ? m : 0) + t),
          o.disableYAxis || (p.y = (o.relative ? h : 0) + e),
          o.contain &&
            ((e = ((r = (e = (t = N(u)).elem.width / v) * n) - e) / 2),
            ...
            "inside" === o.contain
              ...
              : "outside" === o.contain &&
                ((c =
                  (-(r - t.parent.width) - t.parent.padding.left - t.parent.border.left - t.parent.border.right + e) /
                  n),
                (l = (e - t.parent.padding.left) / n),
                (p.x = Math.max(Math.min(p.x, l), c)),
                (s =
                  (-(a - t.parent.height) - t.parent.padding.top - t.parent.border.top - t.parent.border.bottom + i) /
                  n),
    ...
    function b(t, e) {
      ...
      return (
        (!e.force && e.disableZoom) ||
          ...
          (o = f.maxScale),
          e.contain &&
            ((a = (e = N(u)).elem.width / v), (r = e.elem.height / v), 1 < a) &&
            1 < r &&
            ((a = (e.parent.width - e.parent.border.left - e.parent.border.right) / a),
    ...
    function S(t, e, n) {
      ...
      if (a.force || !a.disableZoom)
        return (
          ...
          (e = m),
          (o = h),
          a.focal && ((e = ((r = a.focal).x / t - r.x / v + m * t) / t), (o = (r.y / t - r.y / v + h * t) / t)),
    ...
    function E(t, e, n, o) {
      var r = N(u),
        ...
        r =
          ...
          { x: (c / a) * (a * t), y: (e / i) * (i * t) })
      return S(t, X(X({}, n), { animate: !1, focal: r }), o)
    }
    S(f.startScale, { animate: !1, force: !0 }),
      setTimeout(function () {
      ...
      ;((t, e) => {
        for (var n, o, r = t; null != r; r = r.parentNode)
          if (
            ...
            (o = e.excludeClass),
            (1 === n.nodeType &&
              -1 < " ".concat((n.getAttribute("class") || "").trim(), " ").indexOf(" ".concat(o, " "))) ||
        ...
        g("panzoomstart", { x: (r = m), y: (a = h), scale: v, isSVG: l, originalEvent: t }, f),
        (t = R(M)),
        (i = t.clientX),
        (c = t.clientY),
        (s = v),
    ...
    function A(t) {
      ...
      p &&
        ...
        (n = 1 < M.length),
        (o = v),
        n && (0 === d && (d = W(M)), E((o = b(((W(M) - d) * f.step) / 80 + s).scale), e, { animate: !1 }, t)),
        (n && !f.pinchAndPan) || x(r + (e.clientX - i) / o, a + (e.clientY - c) / o, { animate: !1 }, t))
    }
    function P(t) {
      1 === M.length && g("panzoomend", { x: m, y: h, scale: v, isSVG: l, originalEvent: t }, f)
      var e = M
    ...
    function z() {
      O ||
        ...
        L("move", document, A, { passive: !0 }),
        L("up", document, P, { passive: !0 }))
    }
    return (
      f.noBind || z(),
      {
        bind: z,
        destroy: function () {
          ;(O = !1), V("down", f.canvas ? n : u, o), V("move", document, A), V("up", document, P)
        },
        eventNames: T,
        getPan: function () {
          return { x: m, y: h }
        ...
        pan: x,
        reset: function (t) {
          var t = X(X(X({}, f), { animate: !0, force: !0 }), t),
        ...
        setOptions: function (t) {
          ...
          ;(t.hasOwnProperty("cursor") || t.hasOwnProperty("canvas")) &&
            ((n.style.cursor = u.style.cursor = ""), ((f.canvas ? n : u).style.cursor = f.cursor)),
            t.hasOwnProperty("overflow") && (n.style.overflow = t.overflow),
            t.hasOwnProperty("touchAction") &&
              ((n.style.touchAction = t.touchAction), (u.style.touchAction = t.touchAction))
        },
