  ...
  return {
    ...
    openURLForContract: function (sContract) {
      ...
      switch (sContract) {
        ...
        case "C1":
          sLink =
            "https://help.sap.com/docs/abap-cloud/abap-development-tools-user-guide/use-system-internally-c1?locale=en-US"
          break
        case "C2":
          sLink =
            "https://help.sap.com/docs/abap-cloud/abap-development-tools-user-guide/use-as-remote-api-c2?locale=en-US"
          break
        case "C3":
          sLink =
            "https://help.sap.com/docs/abap-cloud/abap-development-tools-user-guide/manage-configuration-content-c3?locale=en-US"
          break
        case "C4":
          sLink =
            "https://help.sap.com/docs/abap-cloud/abap-development-tools-user-guide/use-in-abap-managed-database-procedures-c4?locale=en-US"
          break
      }
